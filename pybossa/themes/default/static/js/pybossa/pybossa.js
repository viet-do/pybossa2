...
(function(pybossa, $, undefined) {
    ...
    function _createReview(answer) {
        ...
        return _saveReview(review).then(function(data) {return data;});
    }
    ...
    pybossa.saveReview = function (id, answer) {
            return _createReview(answer);
    };
